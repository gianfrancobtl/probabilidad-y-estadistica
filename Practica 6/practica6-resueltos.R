...
# los cuales pierden concentraci髇 a medida que aumentan.
...
# f)
# Si, el qqnorm basado en una muestra aleatoria normal presenta una funci髇
...
# a) Implemento una funci髇 que remplaza cada valor por la sumatoria de (xi-c)^2
l2 = function(c) {
...
# su m韓imo se encuentra cercano a estos valores.

# b) Implemento una funci髇 que remplaza cada valor por la sumatoria de abs(xi-c)
l1 = function (c){
...
# Se puede ver que los gr醘icos de ambas funciones son muy similares.
